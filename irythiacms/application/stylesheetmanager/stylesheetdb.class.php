<?php
/**
 * Purpose: Database interface for the stylesheet manager.
 **/

class StylesheetDB extends Database {
    // Add stylesheet to database
    ...
    // Remove stylesheet from database
    ...
    // Unload currently loaded stylesheet
    ...
    function liststylesheets($table) {
